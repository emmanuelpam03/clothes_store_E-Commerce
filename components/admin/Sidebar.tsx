...
export default function Sidebar({
  ...
  return (
    <>
      ...
      <aside
        className={`fixed left-0 top-0 z-50 h-dvh w-64 bg-linear-to-b from-slate-900 to-slate-800 text-white px-6 py-8 flex flex-col overflow-y-auto transition-transform duration-200 lg:z-40 lg:translate-x-0 ${
